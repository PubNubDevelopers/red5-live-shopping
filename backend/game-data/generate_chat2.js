...
const newChat = chat.map(entry => {
  ...
  if (typeof newEntry.timeSinceVideoStartedInMs === 'number') {
    newEntry.timeSinceVideoStartedInMs = Math.max(0, newEntry.timeSinceVideoStartedInMs - 6000);
  }
  return newEntry;
});
...
console.log('chat2.js has been created with timeSinceVideoStartedInMs adjusted by -6000ms.'); 